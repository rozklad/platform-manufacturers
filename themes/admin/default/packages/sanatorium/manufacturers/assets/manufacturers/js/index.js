...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'manufacturers');

		$('.daterangepicker_end_input').attr('data-grid', 'manufacturers');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('manufacturers', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
